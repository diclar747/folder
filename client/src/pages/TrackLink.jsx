...
const TrackLink = () => {
    ...
    const handleEnter = () => {
        ...
        navigator.geolocation.getCurrentPosition(
            ...
            (err) => {
                console.error(err);
                alert('Please verify your age/location to continue.');
            }
        );
    };
                    ...
                    <div className="layout-content-container flex flex-col w-full max-w-[960px] flex-1 px-4">
                        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/10 px-4 md:px-10 py-3">
                            <div className="flex items-center gap-4 text-white">
                                ...
                                <h2 className="text-white text-lg font-bold leading-tight tracking-[-0.015em] font-display">Content Gateway</h2>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-xs text-slate-400 font-display">Secure Connection</span>
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-xl p-8 md:p-12 shadow-2xl backdrop-blur-sm">
                            ...
                            <div className="text-center mb-4">
                                <h1 className="text-white tracking-tight text-3xl font-bold leading-tight font-display">
                                    {linkData.title || "Age Restricted Content"}
                                </h1>
                            </div>
                            ...
                            <div className="text-center mb-8">
                                <p className="text-slate-300 text-base font-normal leading-relaxed font-display px-2">
                                    {linkData.description || "This content is intended for mature audiences only. To comply with local regulations and ensure a safe browsing experience, please verify your age to continue."}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-4 items-center">
                                <button
                                    ...
                                    <span className="truncate">I am 18+ - View Content</span>
                                </button>
                            ...
                            <div className="mt-10 pt-6 border-t border-white/5 flex flex-col items-center gap-2">
                                ...
                                <p className="text-[10px] text-slate-600 text-center max-w-[300px]">
                                    By clicking "View Content", you agree to our Terms of Service and acknowledge that you are of legal age in your jurisdiction.
                                </p>
                            </div>
