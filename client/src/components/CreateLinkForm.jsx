                    ...
                    <div className="p-6 bg-gray-50/50 dark:bg-slate-900/50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                {/* Image URL only */}
                                <label className="flex flex-col gap-2">
                                    <span className="text-gray-700 dark:text-slate-300 text-xs font-bold uppercase">URL de la Imagen</span>
                                    <input
                                        name="imageUrl"
                                ...
                                <div className="border border-gray-200 dark:border-slate-800 rounded-xl overflow-hidden bg-white dark:bg-slate-950 max-w-sm">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="mt-4 flex justify-between items-center">
                                            <div className="text-[10px] text-slate-400 uppercase font-bold">{new URL(window.location.origin).hostname}</div>
